            ...
            <div class="col-md-8 col-lg-6">
                <div class="card my-5">
                    <div class="card-body text-center p-4 p-md-5">
                        <img src="{{asset('logo/logo-biru.png')}}" class="text-center" height="64" alt="" srcset="">
                    ...
                    <a href="#" class="btn btn-outline-success w-100 mt-4 py-3">
                        <i class="fab fa-whatsapp"></i>
                        <span class="ml-2">Whatsapp</span>
                    </a>
                    <a href="#" class="btn btn-outline-secondary w-100 mt-4 py-3">
                    ...
                    <p class="mt-4" style="font-size:12px">Copyright © 2023.  DATC <a href="{{route('welcome')}}" target="_blank">Website DATC</a> All rights reserved.</p>
                    </div>
                </div>
            </div>
        </div>
