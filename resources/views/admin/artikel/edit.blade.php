        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('artikel.update', ['id' => $artikel->id]) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="link" value="{{ old('link') ?? $artikel->link }}"
                                class="form-control @error('link') is-invalid @enderror" id="exampleInputName1">
                            @error('link')
                                <small class="text-danger"><b>{{ $message }}</b></small>
                            @enderror
                        </div>
