...
@section('title', 'Tambah Artikel Pribadi')
...
<div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Tambah Artikel Pribadi</h4>
                  <p class="card-description">
                    Anda dapat menambah artikel pada form berikut
                  </p>
                  <form class="forms-sample" action="{{route('artikel_pribadi.store')}}" method="POST" enctype="multipart/form-data">
                  @csrf
